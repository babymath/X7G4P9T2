...
function loadQuestion(index) {
    ...
    document.getElementById("question-text").textContent = 
        userLanguage === "english" ? questionData.questionEnglish : questionData.questionHindi;
    ...
    shuffledOptions.forEach(option => {
        ...
        if (userAnswers[index] === option) optionInput.checked = true;
        optionInput.addEventListener("change", () => saveAnswer(index, option));
